...
export const GetInTouch = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center gap-y-16 mb-32 mx-16">
      <div className="flex mt-32 flex-col items-center gap-4 text-center">
        <h2 className="text-6xl font-lobster text-dark-brown">Get in touch</h2>
        <p className="text-light-brown w-1/2">
      ...
      <div className="flex gap-4">
        <div className="bg-beige shadow-xl rounded-sm p-4 gap-y-8 min-w-[450px]">
          <p className="font-semibold text-dark-brown text-2xl">
            Send us a message
          </p>
        ...
        <div className="flex flex-col gap-4 bg-beige shadow-xl rounded-sm p-4 min-w-[450px]">
          <p className="font-semibold text-dark-brown text-2xl">
            Contact Information
          </p>
          <div className="flex gap-2">
            <ClockIcon className="text-dark-brown size-6" />
          ...
          <div className="flex gap-2">
            <PhoneIcon className="text-dark-brown size-6" />
            <div className="flex flex-col">
          ...
          <div className="flex gap-2">
            <EnvelopeIcon className="text-dark-brown size-6" />
            <div className="flex flex-col">
          ...
          <div className="flex gap-2">
            <MapPinIcon className="text-dark-brown size-6" />
            <div className="flex flex-col">
